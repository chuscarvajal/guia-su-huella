...
const reviews = [
  {
    name: "Pablo G.",
    initials: "PG",
    text: "Llevamos a nuestro perro con problemas serios de ladridos y tirones en la correa. En pocas sesiones mejoró muchísimo. El trato es excelente, explican todo con paciencia y amor por los animales.",
    rating: 5,
  },
  {
    name: "Marta S.",
    initials: "MS",
    text: "Sin duda la mejor escuela canina de Sevilla. Muy profesionales, cercanos y con resultados reales. Nuestro perro ha cambiado para bien y nosotros hemos aprendido a entenderlo mucho mejor.",
    rating: 5,
  },
  {
    name: "Roberto F.",
    initials: "RF",
    text: "Increíble experiencia. El entorno natural donde trabajan es precioso y se nota que los perros están muy cómodos. Los resultados desde las primeras sesiones son visibles. Totalmente recomendable.",
    rating: 5,
  },
];
    ...
    <section className="py-16 lg:py-24 bg-[#2b2b2b]">
      <div className="container">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12">
          ...
          <a
            href="https://www.google.com/maps/search/Guia+su+Huella+Sevilla"
            target="_blank"
